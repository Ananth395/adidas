...
with DAG(
    ...
    get_raw_data = _python_operator(url='https://s3-eu-west-1.amazonaws.com/csparkdata/ol_cdump1.json')

    etl_raw_to_parse = _spark_submit_operator(task_type='etl', task_name='raw_to_parse')

    sql_get_top_5_genres = _spark_submit_operator(task_type='sql', task_name='get_top_5_genres')
    sql_get_book_with_most_pages = _spark_submit_operator(task_type='sql', task_name='get_book_with_most_pages')
    sql_get_no_of_published_books_and_authors = _spark_submit_operator(task_type='sql',
                                                                       task_name='get_no_of_published_books_and_authors')
    sql_get_no_of_authors_with_one_book_per_yr = _spark_submit_operator(task_type='sql',
                                                                        task_name='get_no_of_authors_with_one_book_per_yr')
    sql_get_top_5_coauthors = _spark_submit_operator(task_type='sql', task_name='get_top_5_coauthors')
